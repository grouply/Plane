...
def main_menu():
    ...
    while True:
        ...
        if ev.type == pygame.KEYDOWN:
            ...
            draw_text(screen, "Press [ENTER] To Begin", 30, WIDTH/2, 17*HEIGHT/20)
            draw_text(screen, "[A] left [S] down  [D] left  [W] up", 30, WIDTH/2, 18*HEIGHT/20)
            draw_text(screen, "[Space] fire", 30, WIDTH/2, 19*HEIGHT/20)
            pygame.display.update()
    #加载准备声音
    ...
    #加载准备开始界面背景颜色和文本
    screen.fill(BLACK)
    draw_text(screen, "GET READY!", 40, WIDTH/2, HEIGHT/5)
    pygame.display.update()
